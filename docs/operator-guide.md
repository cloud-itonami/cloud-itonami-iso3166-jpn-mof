...
2. Register the client's intake: business type, the specific
   MOF-regulated activity involved, prior filing/compliance
   history in Japan if any.
3. Run the advisor in read-only mode against Ministry of Finance's
   (財務省) published guidance.
...
5. Enable gated filing/compliance-draft assistance once the
   Customs & Tax Compliance Governor contract is trusted; actual submission always
   requires human sign-off.

## Minimum Production Controls

- client-owned data store for compliance documents
- clear provenance (official MOF source citation) for every
...
automated actions cannot bypass the Customs & Tax Compliance Governor, and a working
