(ns mofcompliance.phase
  "Phase 0->3 staged rollout for the JPN-MOF (Ministry of Finance)
  compliance actor.
  ...
  set'). Drafting a real MOF compliance package and submitting it are
  the two real-world acts this actor performs; both are always a human
  operator's call. `mofcompliance.governor`'s
...
(defn verdict->disposition
  "Map a MOF Procurement Compliance Governor verdict to a base
